...
public class MimeTypes {
     ...
     */
    public static final String _RegexFileTypePlainTexts = "(?si)^.+\\.(txt|"
     ...
     */
    public static final String _RegexFileTypeImages = "(?si)^.+\\.(gif|jpe?g|"
     ...
     */
    public static final String _RegexFileTypeAudios = "(?si)^.+\\.(mp[2-3]+|"
     ...
     */
    public static final String _RegexFileTypeVideos = "(?si)^.+\\.(mp[4]+|"
            + "flv|wmv|webm|m4v|3gp|mkv|mov|mpe?g|rmv?|ogv|avi)$";

    /**
     * Regular expression for APK files.
     */
    public static final String _RegexFileTypeApks = "(?si)^.+\\.apk$";
     ...
     * @see http://en.wikipedia.org/wiki/List_of_file_formats
     */
    public static final String _RegexFileTypeCompressed = "(?si)^.+\\.(zip|"
