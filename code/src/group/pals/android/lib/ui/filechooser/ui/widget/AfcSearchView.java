...
public class AfcSearchView extends LinearLayout {
    ...
    private static final String _ClassName = AfcSearchView.class.getName();
    ...
    public static interface OnQueryTextListener {
         ...
         * press on the keyboard or due to pressing a submit button.<br>
         * <br>
    ...
    private final Runnable mAutoSubmissionRunnable = new Runnable() {
        ...
        public void run() {
            if (BuildConfig.DEBUG)
                Log.d(_ClassName, "mAutoSubmissionRunnable.run()");
