...
public class DbUtils {
    ...
    public static final String _DateFormat = "yyyy:MM:dd'T'kk:mm:ss";
    /**
     * SQLite component FTS3.
     * 
     * @since v4.6 beta
     */
    public static final String _SqliteFts3 = "FTS3";
    /**
     * SQLite component FTS4.
     * 
     * @since v4.6 beta
     */
    public static final String _SqliteFts4 = "FTS4";

    /**
     * Hidden column of FTS virtual table.
     */
    public static final String _SqliteFtsColumnRowId = "rowid";
